...
<html>
    ...
    <body style="font-family: 'Poppins', sans-serif; font-size: 20px;">
        ...
        <?php 
            ...
            //query id dari restoran yang tersedia
            $kalimatquery = "SELECT id FROM restaurants"; #untuk execute 
        ...
        <div class="sidebar">
            ...
            <div class="dropdown-container">
                <a href="insertmenu.php" class="active" >Add new menu</a>
        ...
        <div class="content" style="background-color: #3DB2FF; padding-top: 12px; padding-bottom: 8px;">
            <h1 style="font-family: 'Poppins', sans-serif; font-size: xx-large;"><b>ADD MENU</b></h1>
            <br>
            <form action="inserting_menu.php" method="post">

                <!-- pilih id restoran yang tersedia -->
                ...
                <!-- input nama lain -->
                Nama lain: 
                <br><input type="text" name="namalain">
                <br>
                <br>
                ...
                <!-- input deskripsi -->
                Deskripsi: 
                <br><textarea name="deskripsi"></textarea>
                <br>
                <br>
                ...
                <!-- input nama file gambar makanan/minuman -->
                Nama file image: 
