...
<body style="font-family: 'Poppins', sans-serif; font-size: larger">
            ...
            <div class="modal-footer border-0">
                <div class="dropdown">
                    <button class="btn btn-fill dropdown-toggle" type="button" id="dropdownMenu" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <img src="assets/Logo profile.svg" width="20px"><?php echo "   ";
    ...
    <center>
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $harga_final = $_SESSION["final_price"];
            $promo = $_REQUEST['promo'];

            $sql = "INSERT INTO orders (username, nama_promo, harga_akhir, status, nama_penerima, alamat, notelp, payment_method, tanggal) VALUES ('{$_SESSION["username"]}','$promo', $harga_final, 'Diproses', '$name', '$address', '$notelp', '$payment', NOW())";

            if (mysqli_query($conn, $sql)) {
                echo '<center>';
                echo '<div class="container" style="align-items: center;" >';
                echo '<div class="row">';
                echo '<img width: src="assets/centang.jpg">';
                echo '</div><div class="row">';
                echo "<h1>ORDER TELAH DIPROSES</h1>";
                echo '<a href="rating.php" type="btn btn-warning"> Selesaikan pesanan </a>';
                echo '</div></div>';
                echo '</center>';
            } else {
                echo '<center>';
                ...
                echo '<img width: src="assets/centang.jpg">';
                echo '</div><div class="row">';
                echo '<h1>ORDER GAGAL DI PROSES'. $sql. mysqli_error($conn).'</h1>';
                echo '<a href="home.php" type="btn btn-warning"> Back To Home </a>';
                echo '</div></div>';
                echo '</center>';
