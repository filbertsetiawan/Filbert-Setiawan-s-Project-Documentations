...
<html>
        ...
        <script>
            function show(str) {
                if (str == "") {
                    ...
                    xmlhttp.open("GET","updatemenu_show.php?q="+str,true);
                    xmlhttp.send();
                }
            }
        </script> 
    ...
    <body style="font-family: 'Poppins', sans-serif; font-size: 20px;">
        ...
        <?php 
            ...
            //query nama menu untuk ditampilkan 
            $kalimatquery = "SELECT id, nama FROM menu"; #untuk execute 
        ...
        <div class="sidebar">
            ...
            <div class="dropdown-container">
                ...
                <a href="updatemenu.php" class="active">Update menu</a>
        ...
        <div class="content" style="background-color: #3DB2FF; padding-top: 12px; padding-bottom: 8px;">
            <h1 style="font-family: 'Poppins', sans-serif; font-size: xx-large;"><b>UPDATE MENU</b></h1>
            <br>
            <form action="updating_menu.php" method="post">
                <label>Pilih makanan/minuman yang akan diupdate: </label>
                <select name="nama" onchange="show(this.value)" style="background-color: #DEEDF0;">
                <!-- pilih makanan/minuman yg mau diupdate -->
