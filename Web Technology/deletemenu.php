...
<html>
    <head>
        ...
        <title>Backend | Delete Menu</title>
    </head>
    <body style="font-family: 'Poppins', sans-serif; font-size: 20px;">
        ...
        <?php 
            ...
            //query nama menu yang akan didelete
            $kalimatquery = "SELECT nama FROM menu"; #untuk execute 
        ...
        <div class="sidebar">
            ...
            <div class="dropdown-container">
                ...
                <a href="deletemenu.php" class="active">Delete menu</a>
            </div>
        ...
        <div class="content" style="background-color: #3DB2FF; padding-top: 12px; padding-bottom: 8px;">
            <h1 style="font-family: 'Poppins', sans-serif; font-size: xx-large;"><b>DELETE MENU</b></h1>
            <br>
            <form action="deleting_menu.php" method="post">
                <!-- pilih makanan/minuman yg akan didelete -->
                <label>Pilih makanan/minuman yang akan didelete: </label>
                <select name="nama" style="background-color: #DEEDF0;">
                    <option>Pilih</option>
                    <!-- show dari yg sudah diquery -->
                    <?php
                        if ($hasilquery->num_rows > 0) {
                            while($row = $hasilquery->fetch_assoc()) {
                                $nama = $row['nama'];
                                echo "<option value='".$nama."'>".$row['nama']."</option>";
                            }
                        }
                    ?>
                </select>
