                ...
                <div class="col-sm-7">
                    <form method="post">
                        ...
                        <div class="form-group">
                            <input type="submit" class="btn btn-fill" value="Log In" style="margin: 10px;">
                        </div>
                        <p>Don't have an account? <a href="registeruser.php" style="color: #3DB2FF;">Sign up now</a>.</p>
                        <p>Forgot your password? <a href="sendemail.php" style="color: #3DB2FF;">Change your password</a>.</p>
                    </form>
                </div>
            </div>
        </center>
