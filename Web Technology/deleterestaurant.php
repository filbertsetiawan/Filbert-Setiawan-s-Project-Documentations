...
<html>
    <head>
        ...
        <title>Backend | Delete Restaurant</title>
    </head>
    <body style="font-family: 'Poppins', sans-serif; font-size: 20px;">
        ...
        <?php 
            ...
            //query nama restoran 
            $kalimatquery = "SELECT restaurant_name FROM restaurants"; #untuk execute 
        ...
        <div class="sidebar">
            ...
            <div class="dropdown-container">
                ...
                <a href="deleterestaurant.php" class="active">Delete restaurants</a>
            </div>
        ...
        <div class="content" style="background-color: #3DB2FF; padding-top: 12px; padding-bottom: 8px;">
            <h1 style="font-family: 'Poppins', sans-serif; font-size: xx-large;"><b>DELETE RESTAURANT</b></h1>
            <br>
            <form action="deleting_restaurant.php" method="post">
                <!-- pilih restoran yg mau didelete -->
                <label>Pilih restoran yang akan didelete: </label>
                <select name="nama" style="background-color: #DEEDF0;">
                    <option>Pilih</option>
                    <?php
                        if ($hasilquery->num_rows > 0) {
                            while($row = $hasilquery->fetch_assoc()) {
                                $nama = $row['restaurant_name'];
                                echo "<option value='".$nama."'>".$row['restaurant_name']."</option>";
                            }
                        }
                    ?>
                </select>
                <br>
                <br>
                <input class="btn btn-fill" type="submit" value="Delete">
            </form>
        </div>
